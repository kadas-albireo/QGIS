...

{
  ...
  if ( capture )
  {
    connect( mProcess, static_cast < void ( QProcess::* )( QProcess::ProcessError ) >( &QProcess::errorOccurred ), this, &QgsRunProcess::processError );
...
void QgsRunProcess::dialogGone()
{
  ...
  disconnect( mProcess, static_cast < void ( QProcess::* )( QProcess::ProcessError ) >( &QProcess::errorOccurred ), this, &QgsRunProcess::processError );

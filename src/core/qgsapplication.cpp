  ...
  : QApplication( argc, argv, GUIenabled )
{
  ...
  if ( sTranslation != QLatin1String( "C" ) )
  {
    ...
    {
      QgsDebugMsg( QStringLiteral( "loading of qt translation failed %1/qt_%2" ).arg( qtTranslationsPath, sTranslation ) );
    }
    ...
    {
      QgsDebugMsg( QStringLiteral( "loading of qtbase translation failed %1/qt_%2" ).arg( qtTranslationsPath, sTranslation ) );
    }
  }

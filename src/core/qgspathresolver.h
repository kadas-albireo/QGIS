...
class CORE_EXPORT QgsPathResolver
{
  public:
    ...
    */
     ...
     *
     * If multiple writer are set, they will be called in sequence based on the order in which
     * they were originally set.
     *
  ...
  private:
    ...
    static std::vector< std::pair< QString, std::function< QString( const QString & ) > > > sCustomWriters;
};

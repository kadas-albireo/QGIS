  ...
  , mOrientation( orientation )
{
  ...
  mScaleMinPixelsWidth = mRulerFontMetrics->horizontalAdvance( QStringLiteral( "000" ) ) * 2.5;
  ...
  double guideMarkerSize = mRulerFontMetrics->horizontalAdvance( QStringLiteral( "*" ) );
    ...
    case Qt::Vertical:
    {
      ...
      if ( startY < 0 )
      {
        ...
        while ( beforePageCoord > startY )
        {
          ...
          int labelSize = mRulerFontMetrics->horizontalAdvance( label );
